...
//                 children: [
//                   Text("SHOPPING ADDRESS", style: AppTextStyle.bodySmall.copyWith(color: Colors.grey)),
//                   const SizedBox(height: 8),
//                   Text("Tom Riley", style: AppTextStyle.bodyLarge.copyWith(fontWeight: FontWeight.bold)),
//                   const SizedBox(height: 4),
//                   Text("Gopal nagar - 10 thabar road Rajkot, Home", style: AppTextStyle.bodyMedium),
//                   const SizedBox(height: 2),
//                   Text("Rajkot - 360002", style: AppTextStyle.bodyMedium),
//                   const SizedBox(height: 2),
//                   Text("+91 88888 - 55555", style: AppTextStyle.bodyMedium),
//                 ],
//               ),
//             ),
//           ),
...
//               ),
//               child: Text("CHANGE OR ADD ADDRESS", style: AppTextStyle.buttonMedium.copyWith(color: Colors.white)),
//             ),
//           ),
//           const SizedBox(height: 10),

//           // Box 2: Product Detail
//           Expanded(
...
//                         child: Image.asset(shoe.image, width: 80, height: 80, fit: BoxFit.cover),
//                       ),
...
//               child: Column(
//                 children: [
//                   _priceRow("Price ($totalQuantity item)", totalPrice),
...
//             child: ElevatedButton(
//               onPressed: () {
//                 Get.snackbar("Checkout Successful", "Your order has been placed!",
...
//     final style = isBold ? AppTextStyle.bodyLarge.copyWith(fontWeight: FontWeight.bold) : AppTextStyle.bodyMedium;
//     return Padding(
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // Price Summary Box (disamakan dengan PaymentPage)
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 16),
            child: Container(
              width: double.infinity,
